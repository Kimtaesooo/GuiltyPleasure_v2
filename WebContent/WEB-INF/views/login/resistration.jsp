...
<!-- 
 ...
 -->
        ...
        <!-- Bootstrap -->
        <link href="${pageContext.request.contextPath}/design/bootstrap332/css/bootstrap.css" rel="stylesheet" type="text/css"/>
        ...
        <script src="${pageContext.request.contextPath}/design/bootstrap332/js/bootstrap.js"></script>
...
<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
    ...
    <!-- 우측 정렬 네비 바 -->
        ...
        <form class="form-horizontal" role="form" method="post" action="/GuiltyPleasure/logcheck?cmd=logreg" name="logreg" id="logreg">
