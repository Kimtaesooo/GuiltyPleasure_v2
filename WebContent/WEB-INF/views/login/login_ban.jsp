...
<!-- 
 ...
 -->
        ...
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="${pageContext.request.contextPath}/design/login/assets/ico/apple-touch-icon-144-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="${pageContext.request.contextPath}/design/login/assets/ico/apple-touch-icon-114-precomposed.png">
    ...
    <body>
        ...
        <!-- Javascript -->
        <script src="${pageContext.request.contextPath}/design/login/assets/js/jquery-1.11.1.min.js"></script>
