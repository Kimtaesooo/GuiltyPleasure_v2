				...
				<div class="carousel slide" id="theCarousel1">
					...
					<div class="carousel-inner">
    					...
    					<li data-target="#theCarousel1" data-slide-to="1"></li>
  	 					...
  	 					<li data-target="#theCarousel1" data-slide-to="3"></li>
  	 					<li data-target="#theCarousel1" data-slide-to="4"></li>
  	 					<li data-target="#theCarousel1" data-slide-to="5"></li>
  	 					<li data-target="#theCarousel1" data-slide-to="6"></li>
  	 					<li data-target="#theCarousel1" data-slide-to="7"></li>
  	 					<li data-target="#theCarousel1" data-slide-to="8"></li>
  	 					<li data-target="#theCarousel1" data-slide-to="9"></li>
  						</ol><!-- 인디캐이터로 캐러셀안에서 원하는 위치로 옮길때 중간에 생기는 목록같은것 -->
						<!-- carousel-inner로 캐러셀에 들어갈 이미지들을 꼭 묶어줘야한다. -->
						<div class="item active">
							<img class ="center-block" src="/GuiltyPleasure/CORDING/magic/img/002magiceye3d.jpg" />
						</div>
						<div class="item">
							<img class ="center-block" src="/GuiltyPleasure/CORDING/magic/img/003magiceye3d.jpg" />
						</div>
						<div class="item">
							<img class ="center-block" src="/GuiltyPleasure/CORDING/magic/img/004magiceye3d.jpg" />
						</div>
						<div class="item">
							<img class ="center-block" src="/GuiltyPleasure/CORDING/magic/img/005magiceye3d.jpg" />
						</div>
							<div class="item">
							<img class ="center-block" src="/GuiltyPleasure/CORDING/magic/img/006magiceye3d.jpg" />
						</div>
							<div class="item">
							<img class ="center-block" src="/GuiltyPleasure/CORDING/magic/img/007magiceye3d.jpg" />
						</div>
							<div class="item">
							<img class ="center-block" src="/GuiltyPleasure/CORDING/magic/img/008magiceye3d.jpg" />
						</div>
							<div class="item">
							<img class ="center-block" src="/GuiltyPleasure/CORDING/magic/img/009magiceye3d.jpg" />
						</div>
							<div class="item">
							<img class ="center-block" src="/GuiltyPleasure/CORDING/magic/img/010magiceye3d.jpg" />
						</div>
					</div><!-- inner -->
					<a href="#theCarousel1" class="carousel-control left" data-slide="prev">
					<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
					</a>
					<a href="#theCarousel1"  class="carousel-control right" data-slide="next">
